...
- Non-repeatable Read — re-reading the same row yields different values
- Phantom Read — re-running the same query yields a different set of rows
- Lost Update — two transactions overwrite each other's writes
- Each isolation level prevents some subset of these

---

## Common Isolation Problems Diagram

![common_isolation_problems](svg/courses/architecting/architecture-patterns/09_isolation_levels/common_isolation_problems.svg)
...
![standard_isolation_levels](svg/courses/architecting/architecture-patterns/09_isolation_levels/standard_isolation_levels.svg)
...
![optimistic_vs_pessimistic_locking](svg/courses/architecting/architecture-patterns/09_isolation_levels/optimistic_vs_pessimistic_locking.svg)
...
![dealing_with_deadlocks](svg/courses/architecting/architecture-patterns/09_isolation_levels/dealing_with_deadlocks.svg)
...
![multi_version_concurrency_control_mvcc](svg/courses/architecting/architecture-patterns/09_isolation_levels/multi_version_concurrency_control_mvcc.svg)
