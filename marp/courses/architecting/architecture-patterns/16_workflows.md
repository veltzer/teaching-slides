...
- Dependency — a task waits for one or more upstream tasks
- DAG — the directed acyclic graph of tasks and dependencies
- Schedule — when the DAG runs (cron, interval, event-driven)
- Run — one execution of the DAG against a specific time window
- Operator/Activity — the implementation of a task (Python, Bash, SQL, etc.)

---

## Key Workflow Concepts Diagram

![key_workflow_concepts](svg/courses/architecting/architecture-patterns/16_workflows/key_workflow_concepts.svg)
...
![dag_example](svg/courses/architecting/architecture-patterns/16_workflows/dag_example.svg)
...
![apache_airflow_architecture](svg/courses/architecting/architecture-patterns/16_workflows/apache_airflow_architecture.svg)
...
![prefect_architecture](svg/courses/architecting/architecture-patterns/16_workflows/prefect_architecture.svg)
...
![dagster_architecture](svg/courses/architecting/architecture-patterns/16_workflows/dagster_architecture.svg)
...
![netflix_conductor_architecture](svg/courses/architecting/architecture-patterns/16_workflows/netflix_conductor_architecture.svg)
...
![etl_pattern](svg/courses/architecting/architecture-patterns/16_workflows/etl_pattern.svg)

---

## Fan-out/Fan-in Pattern

![fan_out_fan_in_pattern](svg/courses/architecting/architecture-patterns/16_workflows/fan_out_fan_in_pattern.svg)
...
![monitoring_dashboard](svg/courses/architecting/architecture-patterns/16_workflows/monitoring_dashboard.svg)
