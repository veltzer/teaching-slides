...
- Here we focus on states, configuration, and library choice
...
- The named pattern is defined in the Architecture Patterns course
- Here we focus on implementation strategies and capacity planning
- Thread pools, connection pools, semaphores
