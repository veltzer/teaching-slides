...
+------------------+------------------+------------------+
| Runs in current  | Runs in subshell | Text replacement |
| shell process    | (new process)    | before parsing   |
+------------------+------------------+------------------+
| Can modify shell | Cannot modify    | Cannot contain   |
| state (cd, vars) | parent shell     | logic or args    |
+------------------+------------------+------------------+
| Loaded into      | Lives on disk    | Simple shortcuts  |
| memory           |                  |                  |
+------------------+------------------+------------------+
```
