...
| format, join      |     | ceil, floor, log   |
+-------------------+     +-------------------+

+-------------------+     +-------------------+
| Collection Funcs  |     | Encoding Functions |
| length, merge,    |     | jsonencode, base64,|
| flatten, keys     |     | yamlencode, csv    |
+-------------------+     +-------------------+

+-------------------+     +-------------------+
| Filesystem Funcs  |     | Date/Time & Hash  |
| file, fileexists, |     | timestamp, md5,    |
| templatefile      |     | sha256, uuid       |
+-------------------+     +-------------------+
```
