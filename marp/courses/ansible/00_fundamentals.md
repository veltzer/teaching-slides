...
|  No agent needed  |    |  No agent needed  |
+-------------------+    +-------------------+
```
...
+----+-----+                        +----+-----+
     |                                    |
     | (Agent polls)                      | (SSH push)
     |                                    |
+----v-----+                        +----v-----+
| Managed  |                        | Managed  |
| [Agent]  |   <-- Running 24/7     | [Python] |  <-- Only SSH
+----------+                        +----------+
```
...
+---------------------------------------------------+
|                                                   |
|  Core Tools:        Content:        Platform:     |
|  - ansible          - Playbooks     - AWX/Tower   |
|  - ansible-playbook - Roles         - Galaxy      |
|  - ansible-galaxy   - Collections   - EE (Exec    |
|  - ansible-vault    - Modules         Environments)|
|  - ansible-doc      - Plugins       - Navigator   |
|  - ansible-pull     - Filters                     |
|                                                   |
+---------------------------------------------------+
```
