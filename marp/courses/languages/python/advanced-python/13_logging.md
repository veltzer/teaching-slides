...
1. Direct File Collection
   Application → Log Files → Log Collector → Log Storage

2. Syslog Collection
   Application → Syslog → Syslog Server → Log Storage

3. Agent-Based Collection
   Application → Log Files → Collection Agent → Log Storage

4. Direct API Integration
   Application → Log API → Log Storage
```
