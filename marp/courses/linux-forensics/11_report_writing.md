...
| Audience         |     | Audience         |
+------------------+     +------------------+
| IT Security team |     | Legal counsel    |
| System admins    |     | Management       |
| Incident response|     | Human Resources  |
| Other examiners  |     | Judges/Jury      |
| Peer reviewers   |     | Law enforcement  |
+------------------+     +------------------+

Write for BOTH audiences:
- Executive summary for non-technical
- Detailed technical appendices for technical
```
...
Audience: IT/Security team   Audience: Legal/Court
Timeline: Hours to days      Timeline: Weeks to months
Detail: Technical specifics  Detail: Comprehensive
Format: Informal/templates   Format: Formal/structured
Goal: Stop the attack        Goal: Prove what happened
Includes: IOCs, patches      Includes: Chain of custody
Language: Technical           Language: Clear for all
```
...
Finding: Unauthorized Access
  E001: auth.log shows SSH login at 10:30
  E002: Memory shows bash process started at 10:30
  E003: Network shows TCP connection from 10.0.0.99 at 10:30
  -> CORROBORATED across 3 evidence sources

Finding: Malware Installation
  E001: /tmp/.hidden/toolkit.tar.gz created at 10:30:20
  E002: Memory shows wget process at 10:30:15
  E003: HTTP GET to evil.com/toolkit.tar.gz at 10:30:15
  -> CORROBORATED across 3 evidence sources

Finding: Data Exfiltration
  E001: No direct evidence on disk
  E002: Memory shows /etc/shadow was opened
  E003: 2KB outbound to 10.0.0.99:4443 at 10:32
  -> PROBABLE based on E002+E003 correlation
```
