...
<svg width="600" height="250" xmlns="http://www.w3.org/2000/svg">
  ...
  <line x1="150" y1="100" x2="450" y2="100" stroke="#333" stroke-width="2" marker-end="url(#arrowd0_17_syn_flood)"/>
  <line x1="450" y1="150" x2="150" y2="150" stroke="#333" stroke-width="2" stroke-dasharray="5,5" marker-end="url(#arrowd0_17_syn_flood)"/>
  <defs>
    <marker id="arrowd0_17_syn_flood" markerWidth="10" markerHeight="10" refX="9" refY="3" orient="auto">
