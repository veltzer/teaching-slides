...
<svg width="400" height="250" xmlns="http://www.w3.org/2000/svg">
  <text x="200" y="30" text-anchor="middle" font-size="18" font-weight="bold">Template Benefits</text>
  ...
  <text x="295" y="85" text-anchor="middle" font-size="14">Type Safety</text>
  <rect x="50" y="120" width="150" height="40" fill="#ccccff" stroke="#333"/>
  <text x="125" y="145" text-anchor="middle" font-size="14">Performance</text>
  <rect x="220" y="120" width="150" height="40" fill="#ffffcc" stroke="#333"/>
  <text x="295" y="145" text-anchor="middle" font-size="14">Compile-Time</text>
  <text x="200" y="200" text-anchor="middle" font-size="14">Zero runtime overhead!</text>
</svg>
