...
![the_golden_rule_of_git](svg/courses/git/git/04_undoing_changes/the_golden_rule_of_git.svg)

---

## Why Not Rewrite Public History?

![why_not_rewrite_public_history](svg/courses/git/git/04_undoing_changes/why_not_rewrite_public_history.svg)
...
![force_vs_force_lease](svg/courses/git/git/04_undoing_changes/force_vs_force_lease.svg)
...
![amend_workflow](svg/courses/git/git/04_undoing_changes/amend_workflow.svg)
...
![reset_three_modes](svg/courses/git/git/04_undoing_changes/reset_three_modes.svg)
...
![reset_use_cases](svg/courses/git/git/04_undoing_changes/reset_use_cases.svg)
...
![how_revert_works](svg/courses/git/git/04_undoing_changes/how_revert_works.svg)

---

## Reset vs Revert

![reset_vs_revert](svg/courses/git/git/04_undoing_changes/reset_vs_revert.svg)
...
![reverting_merge_commits](svg/courses/git/git/04_undoing_changes/reverting_merge_commits.svg)
...
![rebase_interactive_commands](svg/courses/git/git/04_undoing_changes/rebase_interactive_commands.svg)

---

## Rebase Workflow: Squashing

![rebase_workflow_squashing](svg/courses/git/git/04_undoing_changes/rebase_workflow_squashing.svg)
...
![reordering_commits](svg/courses/git/git/04_undoing_changes/reordering_commits.svg)
...
![cherry_pick_use_cases](svg/courses/git/git/04_undoing_changes/cherry_pick_use_cases.svg)
...
![restore_vs_reset_vs_checkout](svg/courses/git/git/04_undoing_changes/restore_vs_reset_vs_checkout.svg)
...
![understanding_reflog](svg/courses/git/git/04_undoing_changes/understanding_reflog.svg)
...
![recovering_lost_commits](svg/courses/git/git/04_undoing_changes/recovering_lost_commits.svg)
...
![bisect_visualization](svg/courses/git/git/04_undoing_changes/bisect_visualization.svg)
...
![cleaning_repository_size](svg/courses/git/git/04_undoing_changes/cleaning_repository_size.svg)

---

## Undo Strategies by Scenario

![undo_strategies_by_scenario](svg/courses/git/git/04_undoing_changes/undo_strategies_by_scenario.svg)
...
![recovery_checklist](svg/courses/git/git/04_undoing_changes/recovery_checklist.svg)
...
![undoing_things_complete](svg/courses/git/git/04_undoing_changes/undoing_things_complete.svg)
