...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" style="height: 400px; display: block; margin: auto;">
  ...
  <text x="30" y="155" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333">Job 0: collect at DataProcessor.scala:142</text>
  ...
  <text x="30" y="245" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333">Job 1: saveAsTable at ETLPipeline.scala:87</text>
